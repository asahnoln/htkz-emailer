    ...
    protected function createMails(): void
    {
        ...
        \Yii::$app->db->createCommand()
            ->batchInsert(
                ...
                [
                    ['mail test 2', 'mail test 2', 'mail content 2', 1, 1, 0, '1970-01-01 00:00:00', 0, 1, 0, 0, '', date('Y-m-d H:i:s'), '1970-01-01 00:00:00', date('Y-m-d H:i:s'), date('Y-m-d H:i:s', strtotime('8 days ago')), '', ''],
