...
- [x] Изменение статуса рассылки - в процессе
- [ ] Изменение статуса рассылки - закончено, ошибки
- [ ] Проверка необходимости сокращения заголовка письма
- [ ] Какое именно поле цены должно быть взято из API? Сейчас `hotel.forTour`.
